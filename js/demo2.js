...
const entranceAnimationDuration = 1.5;//def(2) duration in seconds for the bike to get to the page center
        ...
        exitFrontWheelAnimationDelay = 0;//def(exitAnimationDelay) Delay before front wheel start rotating
        ...
        /* additionnal params */
        shakingRepetition = 1;//def (3) amount of time we want the shaking animation to repeat ( doesn't affect the duration of the whole animation, it'll just shake more frequently )
...
timelineExit
    ...
    { ease: Power0.easeIn, rotation: "+=360", transformOrigin: "50% 50%", repeat: (exitAnimationDuration) / exitWheelRotationSpeed, yoyo: false }, "0")
    //.to("#bike",0.4,{rotation:-5,transformOrigin:"30% 50%"},"0")
    .to("#bike #wheelf", exitWheelRotationSpeed,
    { ease: Power0.easeIn, rotation: "+=360", transformOrigin: "50% 50%", repeat: (exitAnimationDuration - exitFrontWheelAnimationDelay) / exitWheelRotationSpeed, yoyo: false }, exitFrontWheelAnimationDelay)
...
function resetAllTimelines(callback) {
    ...
    timelineMainAnimation.pause();
    timelineMainFillAnimation.pause();
    timelineMainFillAnimation.invalidate();
    timelineMainFillAnimation.kill();
    timelineMainAnimation.kill();
    callback();
}
