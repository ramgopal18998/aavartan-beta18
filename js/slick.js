    ...
    b = function() {
        function c(c, d) {
            ...
            if (e.defaults = {
                    ...
                    nextArrow: '<button id="sid" type="button" data-role="none" class="slick-next" aria-label="next">></button>',
                    autoplay: 1,
                    autoplaySpeed: 3e3,
                    centerMode: !1,
                    centerPadding: "50px",
